...
def prefetch_test(opt):
    ...
    for ind, (img_id, pre_processed_images) in enumerate(data_loader):
        ...
        # Store model's feature maps
        torch.save(detector.model.post_convGRU, f"fmaps/with_contr/post/post_convGRU_{opt.exp_id}_{ind}")
        torch.save(detector.model.pre_convGRU, f"fmaps/with_contr/pre/pre_convGRU{opt.exp_id}_{ind}")
    ...
    if opt.save_results:
        ...
        json.dump(str(_to_list(copy.deepcopy(results))),
