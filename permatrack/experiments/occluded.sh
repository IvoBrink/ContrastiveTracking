...
# test
CUDA_VISIBLE_DEVICES=0 python test.py tracking --exp_id occluded --dataset kitti_tracking --dataset_version val_half --track_thresh 0.4 --resume --load_model  --is_recurrent --gru_filter_size 7  --num_gru_layers 1 --visibility --visibility_thresh_eval 0.2 --stream_test
